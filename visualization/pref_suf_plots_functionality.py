...
def create_plots(prefix_dicts, 
    ...
    fig = create_plots_log(pref_suf_dfs=[df_prefix_dls, df_prefix_mae, df_suffix_dls, df_suffix_mae], 
                     configs=string_list_models, 
                     log_name=log_name,
                     include_legend=include_legend, # Pass the include_legend parameter
                     time_unit=time_unit)
