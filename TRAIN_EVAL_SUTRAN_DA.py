...
if __name__ == "__main__":
    ...
    # 也就是 'BPIC_17_DR'
    dataset_log_name = 'helpdesk_data'  
    ...
    print(f"Results saved in subdirectory: {os.path.join(dataset_log_name, 'Road_Traffic_data')}") 
    print(f"Final test set metrics saved in: {os.path.join(dataset_log_name, 'Road_Traffic_data', 'TEST_SET_RESULTS')}")